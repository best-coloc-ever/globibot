<home-view>
  ...
  <div class="mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--3-col">
      <div class="mdl-card mdl-shadow--2dp">
        <div class="mdl-card__title" id="logs-title">
          <div class="mdl-cell mdl-cell--2-col">
            <i class="mdl-color-text--blue-grey-400 material-icons">queue_music</i>
          </div>
          <div class="mdl-cell mdl-cell--9-col">
            <h2 class="mdl-card__title-text">Dj</h2>
          </div>
        </div>
         <div class="mdl-card__supporting-text">
          Make the bot speak or play audio on your servers
        </div>
        <div class="mdl-card__actions mdl-card--border">
          <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="#dj">
            Play music
          </a>
        </div>
      </div>
  ...
  <div class="mdl-cell mdl-cell--3-col">
    <div class="mdl-card mdl-shadow--2dp">
      <div class="mdl-card__title" id="logs-title">
        <div class="mdl-cell mdl-cell--2-col">
          <i class="mdl-color-text--blue-grey-400 material-icons">link</i>
        </div>
        <div class="mdl-cell mdl-cell--9-col">
       ...
       <div class="mdl-card__supporting-text">
        Connect your external services to Globibot to improve the range of features you can use with chat commands
      </div>
      <div class="mdl-card__actions mdl-card--border">
        <a class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" href="#connections">
          Manage connections
        </a>
      </div>
    </div>
